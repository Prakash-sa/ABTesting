...
public class RecyclerViewCurrentAdapter extends RecyclerView.Adapter<RecyclerViewCurrentAdapter.ViewHolder> {

    Context context;
    List<ImageFeatures> MainStoreImageHelperList;

    public RecyclerViewCurrentAdapter(Context context, List<ImageFeatures> TempList) {
